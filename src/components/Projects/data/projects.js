const projects = [
    ...
    {
        id: 5,
        title: "DishMarket - Multi-Vendor Food Marketplace",
        description:
            "A modern multi-vendor food marketplace where users can browse restaurants, explore menus, and order meals through a responsive and intuitive interface.",
        image: "/dishmarket.webp",
        link: "/projects/dishmarket",
    }
